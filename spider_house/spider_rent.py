...
def get_pages(area,area_link): 
    ...
    for page in range(1,pages+1): 
        t11 = time.time()
        url = 'https://bj.lianjia.com/zufang/{}/pg{}'.format(pinyin.get(area, format="strip"),str(page))     # 08/27/2018 by kaibo
...
def get_house_info(area, page, url): 
    ...
    try: 
        ...
        for i, title in enumerate(titles):                              # 08/27/2018 by kaibo
            ...
            with open('rent_lianjia_bj.txt','a',encoding='utf-8') as f: 
